# English — Professional Communication Index

Short, interview-oriented notes for **written and spoken** communication in software teams: email, meetings, incidents, reviews, and career narratives.

## Core communication

- [Client Communication Guide](Client_Communication_Guide.md)
- [Email Writing for Software Engineers](Email_Writing_for_Software_Engineers.md)
...
- [Active vs Passive Voice in PRs](Active_vs_Passive_Voice_in_PRs.md)

## Incidents, planning, and stakeholder skills

- [On Call and Incident Communication](On_Call_and_Incident_Communication.md)
- [Documentation Runbooks and Playbooks](Documentation_Runbooks_and_Playbooks.md)
...
- [Career Growth IC to Staff Expectations](Career_Growth_IC_to_Staff_Expectations.md)
- [One on Ones with Your Manager](One_on_Ones_with_Your_Manager.md)

## Learning English (general)

- [English Learning Guide](English_Learning_Guide.md)

## Related in this repository

- [JavaScript](../JavaScript/README.md), [React](../React%20JS/README.md), [Vue](../VueJs/README.md), [Spring Boot](../Spring%20Boot%20Concepts/README.md)

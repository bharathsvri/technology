...
**React** is a JavaScript library for building UIs from **components** and a **declarative** render model. Typically used with **JSX**, a bundler (Vite, Webpack), and optional meta-frameworks (**Next.js**, **Remix**).

## Table of contents

1. [Introduction to React](01-Introduction-to-React.md)
2. [JSX and Rendering](02-JSX-and-Rendering.md)
3. [Function and Class Components](03-Function-and-Class-Components.md)
4. [Props and State](04-Props-and-State.md)
5. [Hooks useState and useEffect](05-Hooks-useState-and-useEffect.md)
6. [Hooks useContext and useReducer](06-Hooks-useContext-and-useReducer.md)
7. [Hooks useMemo useCallback and useRef](07-Hooks-useMemo-useCallback-and-useRef.md)
8. [Custom Hooks](08-Custom-Hooks.md)
9. [Context API](09-Context-API.md)
10. [Forms in React](10-Forms-in-React.md)
11. [React Router](11-React-Router.md)
12. [Data Fetching Patterns](12-Data-Fetching-Patterns.md)
13. [Suspense and Lazy Loading](13-Suspense-and-Lazy-Loading.md)
14. [Error Boundaries](14-Error-Boundaries.md)
15. [Portals and Refs](15-Portals-and-Refs.md)
16. [Performance Optimization](16-Performance-Optimization.md)
17. [Testing with React Testing Library](17-Testing-React-Testing-Library.md)
18. [State Libraries Overview](18-State-Libraries-Overview.md)
19. [React 18 Concurrent Features](19-React-18-Concurrent-Features.md)
...
- [Vue.js](../VueJs/README.md) for comparison
